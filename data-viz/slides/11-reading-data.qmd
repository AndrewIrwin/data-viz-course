...
```{r echo = FALSE}
envcan <- read_csv("static/L11/en_climate_daily_NS_8202251_2020_P1D.csv", show_col_types = FALSE)
cat("Original names:", paste(names(envcan)[c(1,5, 10)], collapse=", "))
cat("Cleaned names:", paste(names(janitor::clean_names(envcan))[c(1,5,10)], collapse= ", "))
```
