...
augment(m1, newdata = new_data, interval = "prediction") |> kable(digits = 2)
```
...
augment(m2, newdata = new_data, interval = "prediction") |>
  kable(digits = 2) # quadratic polynomial
```
...
## Without augment: Predictions from new data
