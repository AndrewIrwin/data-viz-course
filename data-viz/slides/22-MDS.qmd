...
* Use latitude and longitude of cities to compute distance between each pair
  ...
  * **How do we compute that distance? Euclidean distance from latitude and longitude? Great circle distance?**
...
* Be sure the variables (columns) are all measured in the same units
