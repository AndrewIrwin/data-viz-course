...
Allows you to generate a final report.

Easy to detect if a report is complete (Does it render without errors?)
...
* Always check that your document can be rendered (to HTML)
...
The **course notes** contain specific suggestions for using Quarto or R markdown which will be explored in the task for this lesson.


## Exercise

* Practice specific tasks for formatting Quarto documents from course notes
