...
* There are many ways to organize data. The main idea behind tidy data is to standardize the way data are organized, to make working with data simpler for you and others.

* “Tidy datasets are all alike, but every messy dataset is messy in its own way.” (Wickham, following Tolstoy)
