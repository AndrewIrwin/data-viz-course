---
title: "Recreating a plot step by step"
...
![cover image](static/L34/cover-stats-data-models.JPG)
...
gapminder %>% filter(year == 2007) %>%
  ...
  scale_color_manual(values = c("blue", "green", "pink", "yellow", "red")) +
  scale_size_area(max_size = 20) + 
  annotation_custom(grob=ggplotGrob(world_map), xmin=4, ymin=65, ymax=80 ) +
  scale_x_continuous(trans = "log2") +
