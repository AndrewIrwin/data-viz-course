...
* Go to your account on github.com and find the repository for assignment-1. 
...
# Click the link to access the repository on the detailed outline
  ...
  * You must accept an invitation you receive by email from GitHub. Check your junk folder if you can't find it.
  * If it is missing, make sure you have given me your github user name. 
