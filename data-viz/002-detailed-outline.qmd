...
my_paste2 <- function(a,b) {
  case_when(is.na(a) ~ " ",
            is.na(b) ~ a,
            TRUE ~ paste0(a, " (<a href='https://raw.githubusercontent.com/AndrewIrwin/data-viz-2022-course/main/data-viz/slides/", b, ".Rmd'>Rmd</a>) ",
                          "(<a href='live-coding/", b, ".html'>html</a>)")
  )
}
