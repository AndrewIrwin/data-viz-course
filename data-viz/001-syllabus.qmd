...
* Meeting times: Tuesday and Thursday 10:05-11:25 pm Atlantic in Henry Hicks (HH) 212
* Office hours: Tuesday 3:30 pm Atlantic in Chase 225, or by appointment.
...
* Tasks (30%, 1-2 per week, due weekly, equally weighted)
* Assignments (40%, roughly 1 every two weeks, equally weighted)
* Term project, divided into three components
  * Proposal, due Thursday 15 February, 5%
  * Oral presentation, due at the time of the final exam, 10%
  * Report, due Thursday 4 April, 15%

Tasks are due by the end of the day on Monday. Assignments are due on Friday. 
