...
Exercises to practice filter, group_by, summarize, and mutate. File [task-L09-summarize](tasks/task-L09-summarize.Rmd). (Right click the link and select "save as" to get the file on your computer. Then open it with Rstudio.)

Follow the instructions in the file. When you are done, knit the file to be sure there are no errors.
...
File: [task-presentation](tasks/task-presentation.qmd).
...
Make maps described in the file [task-maps](tasks/task-maps.Rmd).

#### Task: Map alternatives (Lesson 29) {#task-16 .unnumbered}

Show geographic data without maps as described in [task-map-alternatives](tasks/task-map-alternatives.Rmd).

### Week 12

#### Task: Factors and Dates (Lesson 30) {#task-17 .unnumbered}

Exercises with strings, factors, dates, and times. See [task-factors-dates](tasks/task-factors-dates.Rmd).
...
See [task-themes](tasks/task-factors-dates.Rmd).
...
Your assignment is to get the repositories for Assignments on to your computer.
